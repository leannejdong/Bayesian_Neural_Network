...
class Network:
    ...
    def ForwardPass(self, X):
        ...
        self.out = self.sigmoid(z3)  # output second hidden layer
    ...
    def decode(self, w):
        ...
        w_layer3 = w[w_layer2size:w_layer2size + w_layer3size]
        self.W3 = np.reshape(w_layer3, (self.Top[2], self.Top[3]))
        self.B3 = w[w_layer2size + w_layer3size + self.Top[2]:w_layer2size + w_layer3size + self.Top[2] + self.Top[3]]
...
class MCMC:
    ...
    def prior_likelihood(self, sigma_squared, nu_1, nu_2, w, tausq):
        h1 = self.topology[1]  # number hidden neurons
        h2 = self.topology[2]
        d = self.topology[0]  # number input neurons
        part1 = -1 * ((d * (h1+h2) + h1+h2 + 2) / 2) * np.log(sigma_squared)
    ...
    def sampler(self):
        ...
        netw = self.topology  # [input, hidden1, hidden2, output]
...
def main():
    ...
    for problem in xrange(2, 3): 
        ...
        topology = [input, hidden1, hidden2, output]
