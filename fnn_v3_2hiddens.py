...
class Network:
    ...
    def ForwardPass(self, X ): 
         ...
         self.out1 = self.sigmoid(z2)  # output second hidden layer
    #     print(self.out1, 'selfout1')
         z3 = self.hidout2.dot(self.W3) - self.B3
         self.out2 = self.sigmoid(z3)
     #    print(self.out2,'selfout2')
     #    print(X,'X')
    # test forward pass
    #self.W1[0,0]=1.1
    #self.W1[0,1]=0.1
    ...
    def BackwardPassMomentum(self, Input, desired, vanilla):   
            out_delta = (desired - self.out2)*(self.out2*(1-self.out2))  
